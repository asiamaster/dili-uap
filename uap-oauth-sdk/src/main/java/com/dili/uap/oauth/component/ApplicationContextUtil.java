...
public class ApplicationContextUtil implements ApplicationContextAware, EnvironmentAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        System.out.println("ApplicationContext配置成功,在普通类可以通过调用ApplicationContextUtil.getAppContext()获取applicationContext对象,applicationContext=" + ApplicationContextUtil.applicationContext);
        System.out.println("--------------------------------------------------------------------------------");
    }
    ...
    public void setEnvironment(Environment environment) {
        if (ApplicationContextUtil.environment == null) {
