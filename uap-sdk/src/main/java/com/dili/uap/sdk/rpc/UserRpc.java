...
public interface UserRpc {
	...
	BaseOutput<Object> registeryUserByApp(@VOField("userName") String userName, @VOField("realName") String realName, @VOField("cellphone") String cellphone, @VOField("email") String email, @VOField(value = "cardNumber", required = false) String cardNumber, @VOField("firmCode") String firmCode, @VOField(value = "departmentId", required = false) Long departmentId, @VOField(value = "description", required = false) String description, @VOField("password") String password, @VOField("confirmPassword") String confirmPassword, @VOField(value = "positionId", required = false) Long positionId, @VOField(value = "superiorId", required = false) Long superiorId, @VOField(value = "gender", required = false) Integer gender);
