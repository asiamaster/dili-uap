...
public class DataDictionaryController {
    ...
    public @ResponseBody List<DataDictionary> list(@ModelAttribute DataDictionary dataDictionary) {
    ...
    public @ResponseBody String listPage(@ModelAttribute DataDictionary dataDictionary) throws Exception {
