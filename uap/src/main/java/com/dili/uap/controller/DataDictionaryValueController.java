...
public class DataDictionaryValueController {
    ...
    public @ResponseBody String listPage(@ModelAttribute DataDictionaryValue dataDictionaryValue) throws Exception {
    ...
    public @ResponseBody BaseOutput insert(@ModelAttribute DataDictionaryValue dataDictionaryValue) {
    ...
    public @ResponseBody BaseOutput update(@ModelAttribute DataDictionaryValue dataDictionaryValue) {
